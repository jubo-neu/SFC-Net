...
class SalObjDataset(data.Dataset):
    def __init__(self, train_root, trainsize):
        ...
        self.bodys  = [self.body_root + f for f in os.listdir(self.body_root) if f.endswith('.png') or f.endswith('.jpg')]
        self.details = [self.detail_root + f for f in os.listdir(self.detail_root) if f.endswith('.png') or f.endswith('.jpg')]
...
def get_loader(train_root, batchsize, trainsize, shuffle=True, num_workers=1, pin_memory=False):
